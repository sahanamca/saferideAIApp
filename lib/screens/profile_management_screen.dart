        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(
              backgroundColor:
                  isActive ? AppConstants.primaryColor : Colors.grey,
              child: Text(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildStatRow('Drowsiness Events',
                '${profile.detectionCounts['drowsiness'] ?? 0}'),
            _buildStatRow('Distraction Events',
                '${profile.detectionCounts['distraction'] ?? 0}'),
            _buildStatRow(
                'Phone Usage', '${profile.detectionCounts['phoneUsage'] ?? 0}'),
            _buildStatRow('Total Events',
                '${profile.detectionCounts.values.fold<int>(0, (sum, count) => sum + count)}'),
          ],
        ),
        actions: [
          TextButton(
