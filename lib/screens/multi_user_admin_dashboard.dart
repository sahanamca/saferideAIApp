...
class MultiUserAdminDashboard extends StatefulWidget {
  ...
  @override
  State<MultiUserAdminDashboard> createState() =>
      _MultiUserAdminDashboardState();
}
...
class _MultiUserAdminDashboardState extends State<MultiUserAdminDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            '🚗 Multi-User Admin Dashboard (${_activeStreams.length} devices)'),
        backgroundColor: Colors.deepPurple,
        foregroundColor: Colors.white,
        actions: [
          IconButton(
            icon: Icon(_selectedView == 'grid'
                ? Icons.grid_view
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text(
                '${stream.detectionStats['totalEvents']} events • ${stream.status}'),
          ],
        ),
        trailing: Column(
          mainAxisAlignment: MainAxisAlignment.center,
